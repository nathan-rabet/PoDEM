...
def Phrase_intj(dom,style,tps):
	...
	Phrase = I+vir+e+Dn+e+N+e+ADJn+e+V+e+Dm+e+M+e+ADJm+pts
	return Phrase
...
def Phrase_bruit1(dom,style,tps):
	...
	Phrase = et+e+B+vir+e+Dn+e+N+e+ADJn+e+V+pts
	return Phrase
...
def Phrase_bruit2(dom,style,tps):
	...
	B = BRUIT()
	V = VerbeM('Vt',N,dom,style,tps)
	Phrase = et+e+B+vir+e+Dn+e+N+e+ADJn+e+V+e+Dm+e+M+e+ADJm+pts
	return Phrase
...
def Phrase_normal(dom,style,tps):
	...
	ADJm = ADJ(M,dom,style)
	V = VerbeM('Vt',N,dom,style,tps)
	Phrase = Dn+e+N+e+ADJn+e+V+e+Dm+e+M+e+ADJm+pts
	return Phrase
...
def Phrase_question(dom,style,tps):
	...
	Phrase = Pq+e+Dn+e+N+e+ADJn+e+V+e+ADV_M+e+Dm+e+M+e+ADJm+e+pi
	return Phrase
...
def Phrase_normal_futur(dom,style):
	...
	Phrase = MOT_F+vir+e+Dn+e+N+e+ADJn+e+V+e+Dm+e+M+e+ADJm+pts
	return Phrase
...
def Phrase_normal_passe(dom,style):
	...
	Phrase = MOT_P+vir+e+Dn+e+N+e+ADJn+e+V+e+Dm+e+M+e+ADJm+pts
	return Phrase
...
def Phrase_excla1(dom,style,tps):
	...
	C = CONJ()
	V = VerbeM('Vt',N,dom,style,tps)
	Phrase = C+e+Dn+e+N+e+ADJn+e+V+e+Dm+e+M+e+ADJm+e+pe
	return Phrase
...
def Phrase_excla2(dom,style,tps):
	...
	C = CONJ()
	V = VerbeM('Vi',N,dom,style,tps)
	Phrase =  C+e+Dn+e+N+e+ADJn+e+V+e+pe
	return Phrase
...
def Phrase_prono(dom,style,tps):
	...
	Phrase = Dn+e+N+e+ADJn+e+V+e+ADV_M+e+ADV+e+pe
	return Phrase
